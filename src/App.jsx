    ...
    <>
      <div id="sidebar">
        ...
        <div id="nav-item-wrapper">
          <p class="info-text">Navigation</p>
          <div className="nav-item">
            ...
            <svg width="24" height="24" viewBox="0 0 48 48" fill="none" style={{transform: "translateX(2px)"}} xmlns="http://www.w3.org/2000/svg">
      ...
      <div className="introduction-wrapper">
        <div className="text-container">
          <div className="text-content">
            <p id="title">Let's power higher performance through...</p>
            <div id="chip-wrapper">
              <p>generative AI</p>
              <p>computer vision</p>
